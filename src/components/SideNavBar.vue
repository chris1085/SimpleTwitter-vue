<template>
    ...
    <div class="buttonList user">
        ...
        <button class="btn">
            <a href="/user/self">
            <p v-if="location === 'userProfile'" class="located" id="routerProfile">
              個人資料
            </p>
    ...
    <div class="buttonList setUp">
        <div class="navItem setting">
             <div v-if="location === 'userSetting'" class="icon">
        ...
        <button class="btn">
            <a href="/setting">
            <p v-if="location === 'userSetting'" class="located" id="routerSetting">
              設定
            </p>
